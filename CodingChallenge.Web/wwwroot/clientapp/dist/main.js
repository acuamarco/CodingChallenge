...
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user.service */ "./app/user.service.ts");
    ...
    AppComponent.prototype.getProjects = function (userId) {
        ...
        this.userService.getProjectsByUser(userId).subscribe(function (data) {
            data.forEach(function (project) {
                project.startDate = moment__WEBPACK_IMPORTED_MODULE_4__(project.startDate).format('MM/DD/YYYY');
                project.endDate = moment__WEBPACK_IMPORTED_MODULE_4__(project.endDate).format('MM/DD/YYYY');
...
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./user.service */ "./app/user.service.ts");
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_endpoint + 'user', this.httpOptions);
    };
    UserService.prototype.getProjectsByUser = function (userId) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_endpoint + 'user/' + userId + '/projects', this.httpOptions);
    };
...
module.exports = __webpack_require__(/*! C:\Marco\Trabajo\Entrevistas\Greenslate\CodingChallenge\CodingChallenge.Web\ClientApp\main.ts */"./main.ts");
